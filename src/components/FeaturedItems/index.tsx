        ...
        return (
          <div className="group" key={feature.key}>
            <div className="flex flex-col gap-y-3 items-center md:items-start">
              <span className="w-14 h-14 flex items-center justify-center rounded-full group-odd:bg-green group-even:bg-darkblue">
                {feature.icon}
              </span>
              <h6 className="text-darkblue font-medium text-xl">
                {feature.title}
              </h6>
              <p className="text-gray">{feature.paragraph}</p>
            </div>
          </div>
        );
      })}
